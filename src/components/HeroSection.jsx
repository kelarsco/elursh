  ...
  return (
    <section className="relative overflow-hidden bg-background">
      <div className="flex flex-col lg:flex-row">
        {/* Left Content */}
        <div 
          className="py-16 lg:py-24 px-8 lg:px-16 animate-slide-in-left relative flex flex-col justify-center h-[50vh] lg:h-[100vh] w-full lg:w-[50vw] order-2 lg:order-none"
          style={{
...
Scaling startups and established eCommerce brands to 7 figures and beyond.          </p>
        ...
        {/* Right Content - Image */}
        <div className="relative animate-slide-in-right h-[60vh] lg:h-[100vh] w-full lg:w-[50vw] order-1 lg:order-none">
